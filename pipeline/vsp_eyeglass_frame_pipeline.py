...
def vsp_eyeglass_frame_pipeline(
    minio_endpoint: str = "https://minio-api-default.apps.cluster-5qlcr.5qlcr.sandbox1342.opentlc.com",
    minio_access_key: str = "admin",
    minio_secret_key: str = "aeadmin123",
    bucket_name: str = "vsp",
    data_filename: str = "synthetic_eyeglass_frames_1k.csv",
    endpoint: str = "https://bge-large-vsp-embedding-demo.apps.cluster-5qlcr.5qlcr.sandbox1342.opentlc.com",
